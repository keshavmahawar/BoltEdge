...
import LocalOfferIcon from '@material-ui/icons/LocalOffer';import TrendingUpIcon from '@material-ui/icons/TrendingUp';
		...
		<div className={classes.root}>
			<div className={classes.root1}>
                ...
                <div style={{display:'flex'}}>
                    ...
                    <div className={classes.root5}>
                        <Paper elevation={5} style={{ background:'#ACC1C6'}}>
                            <div style={{textAlign:'center'}}>
                                <strong>Yours</strong>
            ...
            <div style={{display:"flex", flexWrap:'wrap'}}>
                <div className={classes.root2}>
                    ...
                    <div>
                        <img style={{width:670}} src='https://pbs.twimg.com/media/DlDgB8BU4AAXoGq.jpg' alt="Charts"/>
                    </div>
                    </Paper>
                </div>
